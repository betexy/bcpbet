...
websocket_uid: '6e74de85-ff2a-4a9e-8689-7d7411e6eac6',
...
// -= bcgame =-
// 
'bcgame_login' : 'AllyBredehoft404@hotmail.com',
'bcgame_password' : 'KlaUiEJLYN@1',
'bcgame_phone' : '',
'bcgame_email' : '',
'bcgame_email_password' : '',
'bcgame_urls' : 'https://bc.game/sports',
'bcgame_second_name' : '',
bcgame_jwt : 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NjgwNDkwMDAsIm5iZiI6MTc2ODA0OTAwMCwiZXhwIjoxNzcwNzI3NDAwLCJyZWFkeSI6Ik16UTFZelptWkdNMk1XTXpOekk1T1dRM00yWTNZVFV3TXpNNFpqTm1OVEkwT0E9PU0yVmtORFV4TXpjM1lqRmlZelppWldabU5UVmlOamRtTTJZNVl6ZzJOMk5sTlRsbFpETTNZekExTVRZeFpqbGwifQ.eWX6lPr1EdWjT7IXZPyEBcgErwZjcdwDz9Gsp8eoOb4'
,
bcgame_stakeForks : [{
                    bookie: 'BCGAME',
                    uid: '6e74de85-ff2a-4a9e-8689-7d7411e6eac6',
                    linkToParser: 'http://bcp.bet/abb_pairs_pre_fortune/',
                    url: 'http://bcp.bet/abb_pairs_pre_fortune/',
                    source: '534',
                    currency: 'USD',
                    eventTimeLimit: '1500',
                    eventMaxBets: '1',             
...
class Common {
    ...
    async _sendParserReport(reportData) {
        try {
            console.log('%c[PARSER DEBUG] _sendParserReport called', 'background: blue; color: white; font-weight: bold; padding: 5px;', {
            ...
            console.log('%c[PARSER DEBUG] Sending report to API', 'background: blue; color: white; font-weight: bold; padding: 5px;', {
                reportUrl: reportUrl,
                baseUrl: baseUrl
            });
            ...
            const response = await fetch(reportUrl, {
                ...
                console.error('%c[PARSER DEBUG] Fetch error', 'background: red; color: white; font-weight: bold; padding: 5px;', e);
            ...
            if (response && response.ok) {
                ...
                console.log('%c[PARSER DEBUG] Report sent successfully', 'background: green; color: white; font-weight: bold; padding: 5px;', {
                    response: data,
                ...
                console.warn('%c[PARSER DEBUG] Report send failed', 'background: yellow; color: black; font-weight: bold; padding: 5px;', {
            ...
            console.error('%c[PARSER DEBUG] Exception in _sendParserReport', 'background: red; color: white; font-weight: bold; padding: 5px;', e);
    ...
    _getForkForStakeInit() {
        ...
        this.intervals['forkForStake'] = setInterval(async () => {
            ...
            for (const stakeFork of self.stakeForks) {
                ...
                const isNewParser = stakeFork.link.indexOf('/new/') > -1;
            ...
            if (this.multibet.working) {
                ...
                return {
                    'F_BET': async (message, bk) => {
                        ...
                        const betDataItem = Array.isArray(message.data) ? message.data[0] : message.data;
                        const isNewParser = betDataItem && 
                            (betDataItem._parser_bet_id || betDataItem.betFromParser === true);
