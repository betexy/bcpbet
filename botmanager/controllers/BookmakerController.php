...
use app\models\BookmakerSearch;
...
class BookmakerController extends Controller
{
    ...
    /**
     * Displays a single Bookmaker model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Bookmaker model.
    ...
    /**
     * Deletes an existing Bookmaker model.
