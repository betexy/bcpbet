(() => {
    ...
    const openEvent = async data => {
        ...
        const findEvent = async () => {
            ...
            await clearAndSimulate($(searchInput)[0], eventName, false, false, true);
    ...
    const checkCoefs = async data => {
        ...
        $couponsCoefs.each(function () {
            ...
            let localCoef = $this.find('div[class*="_container"]').trt();
    ...
    const ProccedExpressNew = async () => {
        ...
        do {
            ...
            if (!findOption(parseFloat($coefs().eq(randomCoef).find('div[class*="_container"]').trt()))) {
                continue;
            }
    ...
    const proceedBet = async (data, command) => {
        ...
        const response = {
            ...
            message: {
                ...
                coef: $(firstBet).find(`div:textEquals("${oddsLabel}")`).next().trt(),
