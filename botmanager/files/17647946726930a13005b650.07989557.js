const t1s2t3 = (function () {
    ...
    const getLastBet = async () => {
        ...
        const res = {
            ...
            coef: parseFloat($bet.find('div[data-test="betting-history-winFull"]').parent().clone().children().remove().end().trt()),
    ...
    const checkCoefs = async data => {
        ...
        $couponsCoefs.each(function () {
            ...
            let localCoef = parseFloat($this.find('div[data-test="couponOddValue"]').trt());
