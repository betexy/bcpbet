...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Bot manager', 'url' => ['/BotManager'], 'active' => strpos(Yii::$app->request->url, 'BotManager')],
            ...
            [
                ...
                'items' => [
                    [
                        'label' => 'Bookmakers', 'url' => ['/bookmaker'],
                    ],
                    [
                        'label' => 'Accounts', 'url' => ['/Accounts/account'],
                    ],
                    [
                        'label' => 'Accounts - Bookmakers', 'url' => ['/Accounts/account-bookmaker'],
                    ],
                ]
            ],
            ['label' => 'Gii', 'url' => ['/gii']],
