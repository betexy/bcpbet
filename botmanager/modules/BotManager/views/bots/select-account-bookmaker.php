...
$this->registerJs('function SelectAllWeNeed() {
    ...
    $(\'input[data-rsid="rsid"]:checked\').each(function() {
        ...
        bkSelected.push($(this).attr(\'data-bk\'));
    });  
    if (selected.length === 0) {
        alert("You would select some :)");
    } else {
        parent.AddRelationCallback(selected, bkSelected);
    ...
    echo GridView::widget([
        ...
        'columns' => [
            [
                ...
                'label' => '',
                'value' => function ($m) {
                    return Html::checkbox('rSelectionId[]', false,
                        ['value' => $m->id, 'data-rsid' => 'rsid', 'data-bk' => $m->bookmaker]);
                }
            ],
            [
            ...
            [
                ...
                'filter' => \Constants\Bookmakers::getList()
            ],
            'bm_login',
            'bm_password',
            'comment:ntext',
