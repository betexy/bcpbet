...
namespace app\modules\Emails\helpers\imap;
...
class Mailbox {
	 ...
	 *
	 * @param string $criteria String, delimited by spaces, in which the following keywords are allowed. Any multi-word arguments
     * (e.g. FROM "joey smith") must be quoted. Results will match all criteria entries.
     ...
     * @return int|bool|array - FALSE in the case of call failure
     * @throws Exception
     */
